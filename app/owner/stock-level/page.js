...
export default function OwnerStockLevel() {
  ...
  const handleDateClick = (day) => {
    ...
    router.push(`/owner/stock-level/${formattedDate}`);
  };
    ...
    return (
      <div className="min-h-screen bg-gray-100 p-8">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-3xl font-bold mb-8">Stock Levels</h1>
          <div className="bg-white rounded-lg shadow p-6">
            <p className="text-gray-600">No month has been selected yet.</p>
          </div>
        </div>
      </div>
    );
